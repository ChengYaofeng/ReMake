...
class DecoderBN(nn.Module):
    ...
    def forward(self, features):
        ...
        #(torch.Size([1, 192, 15, 20]), torch.Size([1, 96, 30, 40]), torch.Size([1, 48, 60, 80]), torch.Size([1, 24, 120, 160]))
        ...
        x_d0 = self.up1(x_block4_1, None) #torch.Size([1, 128, 30, 40])
        x_d1 = self.up2(x_d0, x_block3_1) #torch.Size([1, 128, 60, 80])
        x_d2 = self.up3(x_d1, x_block2_1) #torch.Size([1, 128, 120, 160])
        x_d3 = self.up4(x_d2, x_block1) #torch.Size([1, 64, 240, 320])
